<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT `username`,count(*) AS `sum` FROM `auth` group by `username` ORDER BY `sum` DESC");
?>
<!doctype html>
<html lang="ja">
  <head>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="sum.php">合計ログ数</a>
                  <a class="dropdown-item active" href="username.php">ログインユーザー集計</a>
      ...
      var mydata = {
        ...
        datasets: [
          ...
          for(var i = 0;i < $len;i++){
              mydata['labels'].push(tableData[i]['username']);

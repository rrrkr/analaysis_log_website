<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT `password`,count(*) AS `sum` FROM `auth` group by `password` ORDER BY `sum` DESC");
?>
<!doctype html>
<html lang="ja">
  <head>
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item active" href="password.php">パスワード集計</a>
      ...
      var mydata = {
        ...
        datasets: [
          ...
          for(var i = 0;i < $len;i++){
              mydata['labels'].push(tableData[i]['password']);

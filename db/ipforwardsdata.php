<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT * FROM `ipforwardsdata` ORDER BY `id` desc limit 20");
?>
<!doctype html>
<html lang="ja">
  <head>
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item active" href="ipforwardsdata.php">ipforwardsdata</a>
      ...
      <h2>ipforwardsdata</h2>
      <p>ipforwardsdataテーブルから最新20件を取得します</p>
    <!-- show database -->
    ...
    var dataTable = new Tabulator("#example-table", {
        ...
        columns:[
            ...
            {title:"DST_IP", field:"dst_ip"},
            {title:"DST_PORT", field:"dst_port"},

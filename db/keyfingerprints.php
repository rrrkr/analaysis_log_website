<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT * FROM `keyfingerprints` ORDER BY `id` desc limit 20");
?>
<!doctype html>
<html lang="ja">
  <head>
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item active" href="keyfingerprints.php">keyfingerprints</a>
      ...
      <h2>keyfingerprints</h2>
      <p>keyfingerprintsテーブルから最新20件を取得します</p>
    <!-- show database -->
    ...
    var dataTable = new Tabulator("#example-table", {
        ...
        columns:[
            ...
            {title:"IP", field:"ip"},
            {title:"FINGERPRINT", field:"fingerprint"}
        ],
    })
    </script>

<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT * FROM `ipforwards` ORDER BY `id` desc limit 20");
?>
<!doctype html>
<html lang="ja">
  <head>
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item active" href="ipforwards.php">ipforwards</a>
      ...
      <h2>ipforwards</h2>
      <p>ipforwardsテーブルから最新20件を取得します</p>
    <!-- show database -->

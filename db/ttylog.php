<?php
    ...
    $db = new LogDB();
    $result = $db->query("SELECT * FROM `ttylog` ORDER BY `id` desc limit 20");
?>
<!doctype html>
<html lang="ja">
  <head>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item active" href="ttylog.php">ttylog</a>
              </div>
            </li>
